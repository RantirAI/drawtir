    ...
    <TooltipProvider>
      ...
      >
        ...
        <div className="flex items-center gap-1 px-3 py-2 rounded-full bg-background/40 backdrop-blur-2xl border border-white/20 shadow-[0_8px_32px_0_rgba(59,130,246,0.2)]">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button 
                ...
                size="icon" 
                className="h-8 w-8 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-[inset_0_0_20px_rgba(59,130,246,0.6)] group"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-[inset_0_0_20px_rgba(59,130,246,0.6)] group" onClick={onImageUpload}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-[inset_0_0_20px_rgba(59,130,246,0.6)] group" onClick={onAddFrame}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-[inset_0_0_20px_rgba(59,130,246,0.6)] group" onClick={onDuplicate}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-[inset_0_0_20px_rgba(59,130,246,0.6)] group" onClick={onDelete}>
