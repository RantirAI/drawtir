...
void main() {
  ...
  n += noise(uv * 6.0 - time * 0.15) * 0.5;
  n += noise(uv * 12.0 + time * 0.2) * 0.25;
  n /= 1.75;
  
  // Create cosmic clouds
  vec3 color = vec3(
    0.5 + 0.5 * sin(n * u_colorTint.x + time),
    0.5 + 0.5 * sin(n * u_colorTint.y + time + 2.0),
    0.5 + 0.5 * sin(n * u_colorTint.z + time + 4.0)
  );
